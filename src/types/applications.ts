...
> = {
  Development: [
    "The AI Development Team builds real-world AI applications from idea to deployment. As a member, you will work across the stack in small project teams as a developer or tech lead, designing and implementing products that use technologies such as LLMs, agents, machine learning, and modern software engineering practices.",
    "We are looking for students who enjoy building, experimenting, and learning by doing. You do not need to be an expert already, but you should be comfortable writing code, curious about AI systems, and motivated to ship useful projects together with others. The team is a good fit if you want hands-on experience with applied AI, collaborative software development, and taking technical ideas from prototype to working product.",
  ],
  IT: [
