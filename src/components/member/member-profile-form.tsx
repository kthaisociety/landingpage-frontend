...
//   university: string;
//   programme: string;
//   graduationYear: string; // Kept as string for input handling, converted to int on submit
//   githubLink: string;
//   linkedinLink: string;
//   aboutMe: string;
// }
...
//   useEffect(() => {
//     // Only populate if the profile actually exists in the DB
...
//           linkedinLink: profile.linkedInLink || "", // Mapping from GET 'linkedInLink'
...
//         ...formData,
//         // Convert the string input to an integer for the Go backend
//         graduationYear: formData.graduationYear ? parseInt(formData.graduationYear, 10) : 0,
//       });
