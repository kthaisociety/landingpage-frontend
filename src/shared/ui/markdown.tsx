    ...
    >
      <ReactMarkdown
        ...
        components={{
          ...
          h1: ({ node: _node, ...props }) => (
            <h1
              className="text-4xl font-bold mb-6 mt-0 first:mt-0 tracking-tight text-secondary-black"
              {...props}
            />
          ),
          h2: ({ node: _node, ...props }) => (
            <h2
              className="text-3xl font-bold mb-4 mt-8 tracking-tight text-secondary-black"
              {...props}
            />
          ),
          h3: ({ node: _node, ...props }) => (
            <h3
              className="text-2xl font-bold mb-3 mt-6 tracking-tight text-secondary-black"
              {...props}
            />
          ),
          h4: ({ node: _node, ...props }) => (
            <h4
              className="text-xl font-bold mb-2 mt-5 tracking-tight text-secondary-black"
              {...props}
            />
          ),
          p: ({ node: _node, ...props }) => (
          ...
          li: ({ node: _node, ...props }) => (
            <li
              className="pl-1 my-1 leading-relaxed text-base text-gray-700"
              {...props}
            />
          ),
        }}
